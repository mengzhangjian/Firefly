...
class TargetLMLoss(Loss):
    ...
    def __call__(self, model, inputs, training_args, return_outputs=False):
        ...
        #Remember that you train GPT-2 by doing next-token prediction, therefore you need to compare the i-th input label--the truth--with what the model predicted: the (i-1)th output. Hence the indices shift.
